...
<main id="main" class="main">
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/help-center/help-center/help-center/pages/content/dashboard/dashboard.php">Home</a></li>
  ...
  <section class="section dashboard">
    <div class="row">
      <div class="product-list">
        <?php
        require_once("/xampp/htdocs/help-center/help-center/help-center/pages/core/connection.php");
            ...
            <div class="col-12 col-md-4 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  ...
                  <a href="shop-single.html" class="h5 text-decoration-none text-dark"><?= $row['name']; ?></a>
                  <p class="card-text">
