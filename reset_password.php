    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($new_password == $confirm_password) {
                ...
                $update = "UPDATE user_form SET password = '$new_password', reset_token = NULL WHERE reset_token = '$token'";
        ...
        // Invalid token
        echo "Invalid token. Please make sure you have the correct link or request a new password reset.";
    }
} else {
    // Token not provided
